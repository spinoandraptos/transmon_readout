...
class ResidualPhotonCLEAR(Experiment):
...
class ResidualPhotonRect(Experiment):
    """Residual Photon Measurement post Pulse"""
    ...
    def sequence(self):
        ...
        # Play CLEAR Pulse
        self.resonator.play(self.readout_pulse)
        qua.align(self.qubit, self.resonator)
...
if __name__ == "__main__":
    ...
    pulses = {
        "echo_pulse": f"{qubit}_pi_8",
        "qubit_drive": f"{qubit}_pi2_8",
    ...
    for relax_time in times:
        ...
        expt = ResidualPhotonRect(FOLDER, modes, pulses, sweeps, datasets, **parameters)
        expt.run()
    ...
    for relax_time in times:
        ...
        expt = ResidualPhotonCLEAR(FOLDER, modes, pulses, sweeps, datasets, **parameters)
        expt.run()
